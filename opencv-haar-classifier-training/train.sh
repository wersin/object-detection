...
#================================================================
#% SYNOPSIS
#+    ${SCRIPT_NAME} [-h] [-w<width>] [-h<heigth>] [-m<amt RAM>]
#%
#% DESCRIPTION
#%    Creates Lists for the images located in 'positives' and negatives Folder
#%    Then based on the samples creates more for the training stage.
#%    The originals are rotated, scaled... and a lot 'new positives' ones are created.
...
#%
#% EXAMPLES
#%    ${SCRIPT_NAME} $1 -w 80 -h 80 -m 8192
#%
#================================================================
#- IMPLEMENTATION
